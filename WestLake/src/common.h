...
// 88 41 10 C7 41 12 01 ? ? ? 66 C7 41 1C ? 01 88 41 16
#define DECID(v10) __ROL4__(v10 ^ 0xC5EEACE1, 6) ^ (__ROL4__(v10 ^ 0xC5EEACE1, 6) << 16) ^ 0x9EF8717A
...
#define HEALTH					0xAB8
#define GROGGYHEALTH			0x1BD8

// 44 0F B6 81 ? ? ? ? 41 0F B6 C0 24 01 3A C2 74 13 41 80 E0 FE 44 0A C2 44 88 81 ? ? ? ? E9 ? ? ? ?
#define DROPPEDITEMARRAY		0x328 // 0x318  jmp     sub_1424CECF0
...
// LastTeamNum
#define TEAM					0xB70 // 19A0

// 83 F8 03 74 08 48 8B CB E8 ? ? ? ? B0 01 48 8B 4D ? 48 33 CC E8
#define ROOTCOMPONET			0x108	//mov     rdx, [rbx+148h] 下面一个
...
#define WEAPONTRAJECTORYDATA	0xC18
#define TRAJECTORYCONFIG		0xB8
#define VDRAGCOEFFICIENT		0x20
#define TRAJECTORYGRAVITYZ		0xD5C
