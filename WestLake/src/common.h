...
// 88 41 10 C7 41 12 01 ? ? ? 66 C7 41 1C ? 01 88 41 16
#define DECID(v10) __ROL4__(v10 ^ 0xAE5C6460, 4) ^ (__ROL4__(v10 ^ 0xAE5C6460, 4) << 16) ^ 0x59364C30
...
#define GAMEINSTANCE			0xA18

// 48 8B C8 33 D2 E8 ? ? ? ? 48 3B C6 0F 85 ? ? ? ?
#define LOCALPLAYER				0xC8
...
#define MESH					0x508 // mov     rbx, [rcx+4A0h]

// 0F 57 C0 0F 2F 81 ? ? ? ? 72 0C
#define HEALTH					0xB78
#define GROGGYHEALTH			0xBF4

// 44 0F B6 81 ? ? ? ? 41 0F B6 C0 24 01 3A C2 74 13 41 80 E0 FE 44 0A C2 44 88 81 ? ? ? ? E9 ? ? ? ?
#define DROPPEDITEMARRAY		0x348 // 0x318  jmp     sub_1424CECF0
...
// LastTeamNum
#define TEAM					0x1398 // 19A0

// 83 F8 03 74 08 48 8B CB E8 ? ? ? ? B0 01 48 8B 4D ? 48 33 CC E8
#define ROOTCOMPONET			0x330	//mov     rdx, [rbx+148h] 下面一个
...
#define REPLICATEDMOVEMENT		0x70
