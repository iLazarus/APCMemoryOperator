...
struct AActor {
	char pad0[0x18];
	__int32 encryptId; //0x18
	char pad1[0x1E4];
	__int64 droppedItemPtr; //0x200
	__int32 droppedItemCount; //0x208
	char pad2[0x1B4];
	__int64 encryptRoot; //0x3C0
	char pad3[0xC0];
	__int64 mesh; //0x488
	char pad4[0x78];
	__int64 itemPackagePtr; // 0x508
	__int32 itemPackageCount; // 0x510
	char pad5[0x958];
	float groggyHealth; //0xE6C
	char pad6[0xA8];
	float health; //0xF18
	char pad7[0x5FC];
	__int64 team; //0x1518
