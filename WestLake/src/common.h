...
// 88 41 10 C7 41 12 01 ? ? ? 66 C7 41 1C ? 01 88 41 16
#define DECID(v10) __ROL4__(v10 ^ 0x54617101, 3) ^ (__ROL4__(v10 ^ 0x54617101, 3) << 16) ^ 0xD5810FE5
...
#define REPLICATEDMOVEMENT		0xB8
