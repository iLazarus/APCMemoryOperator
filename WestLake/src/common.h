...
// 88 41 10 C7 41 12 01 ? ? ? 66 C7 41 1C ? 01 88 41 16
#define DECID(v10) __ROL4__(v10 ^ 0x1D45DC52, 11) ^ (__ROL4__(v10 ^ 0x1D45DC52, 11) << 16) ^ 0x177AC62C
...
#define MESH					0x498 // mov     rbx, [rcx+4A0h]

// 0F 57 C0 0F 2F 81 ? ? ? ? 72 0C
#define HEALTH					0x1BD0
#define GROGGYHEALTH			0x1610

// 44 0F B6 81 ? ? ? ? 41 0F B6 C0 24 01 3A C2 74 13 41 80 E0 FE 44 0A C2 44 88 81 ? ? ? ? E9 ? ? ? ?
#define DROPPEDITEMARRAY		0x220 // 0x318  jmp     sub_1424CECF0
...
// LastTeamNum
#define TEAM					0xC30 // 19A0

// 83 F8 03 74 08 48 8B CB E8 ? ? ? ? B0 01 48 8B 4D ? 48 33 CC E8
#define ROOTCOMPONET			0x168	//mov     rdx, [rbx+148h] 下面一个
...
#define WEAPONPROCESSOR			0xC78
#define EQUIPPEDWEAPONS			0x290
#define WEAPONTRAJECTORYDATA	0xC28
#define TRAJECTORYCONFIG		0xB0
#define VDRAGCOEFFICIENT		0x20
#define TRAJECTORYGRAVITYZ		0xD7C
#define SIMULATIONSUBSTEPTIME	0x1C


#define VEHICLERIDERCOMPONENT	0x1678
