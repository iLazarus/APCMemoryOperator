...
// BRO.ClearIDCLevel
#define UWORLD					0x6008928 //0x61754E8

// 48 8D 3D ? ? ? ? 33 C0 B9 ? ? ? ? F3 48 AB 48 8D 3D ? ? ? ? B9 ? ? ? ? F3 48 AB 48 8B 3D + 1FA0
#define GNAMES					0x611B120 + 0x1FA0

// c1 ? ? 8b ? c1 ? 1f 03 ? 69 ? ? ? ? ? 44 2b f8
#define GNAMECHUNKSIZE			0x3E14
...
// 88 41 10 C7 41 12 01 ? ? ? 66 C7 41 1C ? 01 88 41 16
#define DECID(v10) __ROL4__(v10 ^ 0xFF648203, 3) ^ (__ROL4__(v10 ^ 0xFF648203, 3) << 16) ^ 0x298875A7

//  E8 ? ? ? ? 84 C0 74 16 F6 83 ? ? ? ? ?
//  E8 ? ? ? ? 39 5C 24 48 7E 29
#define LEVEL					0x7F8
#define ACTORS					0x228

// E8 ? ? ? ? 48 8B C8 33 D2 E8 ? ? ? ? 48 ? ? 48 ? ? 0F
#define GAMEINSTANCE			0x900
...
// LastTeamNum
#define TEAM					0xE00 // 19A0

// 83 F8 03 74 08 48 8B CB E8 ? ? ? ? B0 01 48 8B 4D ? 48 33 CC E8
#define ROOTCOMPONET			0x2F0	//mov     rdx, [rbx+148h] 下面一个
...
#define WEAPONPROCESSOR			0xD90
#define EQUIPPEDWEAPONS			0x2A0
#define WEAPONTRAJECTORYDATA	0xD08 //0xC40
#define TRAJECTORYCONFIG		0xB8
#define VDRAGCOEFFICIENT		0x20
#define TARJECTORYGRAVITYZ		0xBA4
#define SIMULATIONSUBSTEPTIME	0x1C
#define VDRAGCOEFFICIENT		0x20


#define VEHICLERIDERCOMPONENT	0x15D0
